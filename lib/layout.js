  ...
  <style>
    ...
    */
    :root {
      ...
      --header-dark: #0c0614; /* Liam's usual dark blue/violet (Camille_website's uColorPaper) -- lives on the header only now, not the whole page */
      ...
      --card-bg: rgba(234, 235, 231, 0.9); /* near-neutral light grey, just enough green mixed in (not pistachio) to read as a different surface from --canvas underneath */
...
<body class="bg-[#e5e3e8] text-[${COLORS.bodyText}] min-h-screen">
    ...
    <div class="${shellWidth} mx-auto px-4">
      <div class="flex items-center justify-between h-20 gap-4">
        <div class="flex items-center">
          <span class="brand-mark font-light text-2xl uppercase tracking-wide text-[${COLORS.brandBlue}]">Buildscope</span>
        </div>
  ...
  <script>
    (function () {
      ...
      var LAYERS = [
        { count: 14, minR: 1,   maxR: 2,   drift: 0.010, parallax: 0.02, color: 'rgba(90,74,110,0.12)' },
        { count: 10, minR: 2,   maxR: 3.5, drift: 0.018, parallax: 0.05, color: 'rgba(74,54,88,0.12)' },
        { count: 6,  minR: 3,   maxR: 5,   drift: 0.028, parallax: 0.09, color: 'rgba(54,37,72,0.10)' },
      ];
