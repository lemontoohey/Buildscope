  ...
  <style>
    ...
    */
    :root {
      ...
      --card-bg: rgba(242, 238, 248, 0.92); /* old-master violet-white -- a warm, pale canvas-priming white with a violet cast, not neutral grey-green */
    ...
    (function () {
      ...
      function frame(ts) {
        ...
        layers.forEach(function (layer) {
          ctx.filter = 'blur(' + (layer.def.blur * dpr) + 'px)';
