  ...
  <script>
    (function () {
      ...
      function computeViewportScale() {
        ...
        // Floor is deliberately low (not 0.4) -- the earlier floor kept phone
        // dots ~48% bigger, relative to the screen, than they are on desktop,
        // which is exactly why they were still reading as visible bubbles.
        return Math.max(0.18, Math.min(1, minDimension / tunedForDimension));
      }
